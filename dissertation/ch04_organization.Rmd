...
[1d] This asymmetry was more pronounced for some characters (`r nonzero_fun(regtab = regtab_d2_ad_scored_ad_diff, which_pair = "BODY - HEART", pos_neg = "pos")`), and less pronounced for others (`r nonzero_fun(regtab = regtab_d2_ad_scored_ad_diff, which_pair = "BODY - HEART", pos_neg = "neg")`; see the "Target character" row for the "BODY-HEART" comparison in Table 4.x). A full discussion of the differences between target characters is beyond the scope of this chapter.
...
[1d] Again, this asymmetry was more pronounced for some characters (`r nonzero_fun(regtab = regtab_d2_ad_scored_ad_diff, which_pair = "BODY - MIND", pos_neg = "pos")`), and less pronounced for others (`r nonzero_fun(regtab = regtab_d2_ad_scored_ad_diff, which_pair = "BODY - MIND", pos_neg = "neg")`; see the "Target character" row for the "BODY-MIND" comparison in Table 4.x). A full discussion of the differences between target characters is beyond the scope of this chapter.
...
[1d] Again, this asymmetry was more pronounced for some characters (`r nonzero_fun(regtab = regtab_d2_ad_scored_ad_diff, which_pair = "HEART - MIND", pos_neg = "pos")`), and less pronounced for others (`r nonzero_fun(regtab = regtab_d2_ad_scored_ad_diff, which_pair = "HEART - MIND", pos_neg = "neg")`; see the "Target character" row for the "HEART-MIND" comparison in Table 4.x). A full discussion of the differences between target characters is beyond the scope of this chapter.
