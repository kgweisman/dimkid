...
```{r}
plot_d1a_scored_ad_diff <- diffplot_fun(d1a_ad_scored_ad_diff)
```
...
```{r}
plot_d1b_scored_ad_diff <- diffplot_fun(d1b_ad_scored_ad_diff)
```
...
```{r}
plot_d1c_scored_ad_diff <- diffplot_fun(d1c_ad_scored_ad_diff)
```
...
```{r}
plot_d1d_scored_ad_diff <- diffplot_fun(d1d_ad_scored_ad_diff, colors21)
```
...
```{r}
figure4.1diff_plots <- plot_grid(plot_d1a_scored_ad_diff + 
                                   labs(title = "Study 1a, Adults") +
                                   theme(legend.position = "none"), 
                                 plot_d1b_scored_ad_diff + 
                                   labs(title = "Study 1b, Adults") +
                                   theme(legend.position = "none"),
                                 plot_d1c_scored_ad_diff + 
                                   labs(title = "Study 1c, Adults") +
                                   theme(legend.position = "none"), 
                                 plot_d1d_scored_ad_diff + 
                                   labs(title = "Study 1d, Adults") +
                                   theme(legend.position = "none"), 
                                 ncol = 2, rel_widths = c(1, 1.2), 
                                 labels = "AUTO")

figure4.1diff_leg <- plot_grid(
  get_legend(plot_d1b_scored_ad_diff +
               ...
               scale_fill_manual("Target character",
                                 ...
                                 guide = guide_legend(direction = "vertical",
                                                      ncol = 1))),
  get_legend(plot_d1d_scored_ad_diff +
...
figure4.1diff_plots_leg <- plot_grid(figure4.1diff_plots, figure4.1diff_leg,
                                     ncol = 2, rel_widths = c(1, 1))

figure4.1diff_cap <- add_sub(figure4.1diff_plots_leg, str_wrap("PLACEHOLDER", 110), x = 0, hjust = 0)
```

```{r, include = T, fig.width = 5, fig.asp = 1}
ggdraw(figure4.1diff_cap)
```
