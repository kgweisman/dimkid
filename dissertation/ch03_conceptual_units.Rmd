...
- _Rotation_: To maximize interpretability factors, I present varimax-rotated solutions, which constrain all factors to be orthogonal. (For solutions using oblique ["oblimin"] rotations, which allow for correlated factors, [XX SEE APPENDIX?].)
