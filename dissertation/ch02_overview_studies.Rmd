...
As in Study 2, I planned to drop trials with response times that were faster than a preset criterion of 250ms, but there were none among children, and I failed to record response times among adults. As in Study 2, participants were retained regardless of skipped trials. Overall, none of adults or older children's trials, and only `r round(sum(is.na(d3_46_wide))/sum(!is.na(d3_46_wide))*100, 2)`% of younger children's trials (_n_=`r sum(is.na(d3_46_wide))`) were missing data.
