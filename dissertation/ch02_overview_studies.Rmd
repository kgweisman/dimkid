...
The organization of Chapters IV-VI is somewhat unconventional. Rather than introducing a new study in each chapter, I draw on a set of three developmental studies (Studies 2-4) in Chapter IV, and then return to re-analyze these same three studies in Chapter V, and again in Chapter VI; in other words, instead of proceeding study by study (including multiple analyses for each study), I proceed analysis by analysis, drawing on the full set of studies for each analysis. My goal in presenting these results in this unusual manner is to paint a holistic picture of developmental change in each of these  distinct aspects of conceptual representation, without requiring the reader to thumb back and forth between chapters to make comparisons across parallel analyses (or switch back and forth between different complex analyses within a single chapter).

With this roadmap in mind, in the current chapter I describe the methods and analyses for all of the studies included in this dissertation. This chapter is intended to provide the reader with a sense of the general methods common to all studies, as well as an easily accessible resource for finding details about any particular study or any particular analysis as they become relevant in Chapters III-VI. The chapter also provides an overview of the different "passes" at analysis that inform my overview of adult conceptual structure in Chapter III and that organize my three-pronged approach to investigating conceptual development in Chapters IV-VI.
...
In the current studies, I instead chose to examine conceptual representations of mental life by documenting participants' mental capacity attributions to a wide variety of familiar entities that might be perceived to vary in their mental lives, including humans, non-human animals, technologies, and inert objects). These studies were designed to capture participants' beliefs about the _co-occurrence_ of a diverse range of mental capacities: When a participant indicates that some entity has one capacity (e.g., for pain, or happiness, or memory), what other capacities do they tend to attribute to that entity? This general strategy has been employed by several research teams in studies of adults' understanding of the mind, yielding fascinating results that have been met with great interest in the burgeoning field of "mind perception" (XX CITE Gray et al., XX CITE Haslam? XX CITE Weisman et al.?). 

At its core, this approach centers on asking participants straightforward questions about familiar entities in the world (e.g., "Can a robot feel happy?", "Can a beetle remember things?"). Such questions may be easier, quicker, and more enjoyable for particpants - particularly children - to answer than the more abstract, hypothetical, or metacognitive tasks described above. In the current studies, I chose to ask each participant about many mental capacities for just 1-2 target characters (rather than, e.g., asking each participant about a single mental capacity for many target characters, as in XX CITE Gray et al., 2007; XX CITE Haslam?) - an approach that I have argued confers the major advantage of focusing participants' attention on the similarities, differences, and relationships among a wide range of mental capacities, facilitating their engagement with deep questions about the nature of mental life while remaining grounded in concrete, real-world examples (see Weisman et al., 2017). The simplicity and concereteness of this approach opens up the possibility of using the same experimental method to study conceptual representations across a wide age range - the primary goal of this dissertation.

This dissertation features two variants of this general approach. In some studies (Studies 1a-1c, Study 2, and Study 4), participants were asked to reason about two "edge cases" in social reasoning: beetles and robots. Because beetles are animals and robots are artifacts, this pair provides insight into the role of biological life in attributions of mental life - an issue of particular interest from a developmental perspective, given the long history of work on the development of the animate-inanimate distinction and its relation to folk psychology (XX CITE Gelman & Opfer, R. Gelman & Spelke, others?). Most critically for my bottom-up approach to uncovering conceptual structure, the "mental lives" of these entities are controversial: People differ in their assessments of the mental capacities of beetles and robots. This allowed me to address the following question: _When participants disagree about the mental capacities of some entity, which capacities "go together"?_ Other studies (Study 1d and Study 3), included a more diverse range of target characters for participants to reason about, including humans (e.g., adults, children), non-human animals (e.g., mammals, birds, insects), technologies (e.g., robots, computers), and inert objects (e.g., toys, tools). This allowed me to address a subtly different question: _Which capacities "go together" when different entities are percieved to have different mental capacity profiles?_ Interestingly, these two variants on the general approach yielded very similar pictures of conceptual representations of mental life, both among adults and among children; I will return to this point in the General Discussion. [XX CHECK THAT THIS IS TRUE]

In the following sections, I describe in greater detail the methods and analyses for the four sets of studies included in this dissertation.
...
The list of 40 mental capacities employed in these studies was generated from an a priori conceptual analysis of candidate ontological categories of mental life, with the constraint that each category should include at least five items of varying valence, complexity, and phrasing; see Table 2.1. [XX MAKE THIS TABLE! fill in for all studies.]

In Studies 1a-1b, participants (Study 1a: _n_=405 US adults; Study 1b: _n_=406 US adults) were randomly assigned to assess one of two target characters (either a beetle or a robot) on all 40 mental capaciaties. [XX This is the "edge case" approach described above.]

In Study 1c, _n_=400 US adults were asked to assess two target characters (a beetle and a robot), presented side-by-side with left-right order determined randomly, on all 40 mental capaciaties. [XX This is the "edge case" approach described above.]

In Study 1d, _n_=431 US adults were randomly assigned to assess one of 21 target characters on all 40 mental capacities. The list of characters again included a beetle and a robot (as in Studies 1a-1c), as well as a stapler, a car, a computer, a microbe, a fish, a blue jay, a frog, a mouse, a goat, a dog, a bear, a dolphin, an elephant, a chimpanzee, a fetus, a person in a persistent vegetative state, an infant, a child, and an adult. [XX This is the "diverse range of targets" approach described above.]
...
The 20 mental capacities were a subset of the 40 items used in Study 2, chosen to cover a simialr range of capacities as included in Studies 1-2 and to include some of the strongest-loading items for each of the three factors uncovered among adults in Study 2 (see Table 2.1) [XX MAKE THIS]. As in Study 2, each mental capacity was associated with a short, preset definition. Both older and younger children were encouraged at the beginning of the study to ask questions if they did not know what a word meant, in which case they were given these definitions. (Adults did not have access to these definitions.)
...
To extend the results of Study 3, and for the sake of completeness of the comparison between children in early chidlhood, middle childhood, and adulthood, in Study 4 I returned to the "edge case" approach, limiting the target characters to a beetle and a robot (as in Studies 1a-1c and Study 2).
