...
IFcor_study1 %>%
  ...
  #   TRUE ~ NA_character_)) %>%
  # arrange(study, sample, ur_factor1, ur_factor2, factor1, factor2) %>%
  ggplot(aes(x = interaction(ur_factor1, ur_factor2), y = cor, color = study)) +
  facet_grid(solution ~ ., scales = "free_y") +
