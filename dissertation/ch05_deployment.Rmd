...
Finally—in contrast to what one might expect if children attributed more mental life across the board to animate than inanimate objects—_MIND_ scores were generally higher among children who assessed the robot (the inanimate target character) than among children who assessed the beetle (the animate target character; see Table 5.2, "Beetle vs. GM" row for the MIND domain). Moreover, with age, children's _MIND_ scores for both characters generally increased (and Table 5.2, "Exact age" and "Interaction" rows for the MIND domain, and Figure 5.3, rightmost plot).
...
Children's _BODY_ scores were generally higher than adults' (see Table 5.3, "Children vs. adults" row for the BODY domain). This appears to have been particularly true for the robot (see Figure 5.4, top row); as a result, the difference between the beetle and the robot was attenuated among children, relative to adults (see Table 5.3, "Interaction" row for the BODY domain).

Children's _HEART_ scores were also higher than adults' (see Table 5.3, "Children vs. adults" row for the HEART domain, and Figure 5.4, middle row), but this difference did not vary substantially across target characters (see Table 5.3, "Interaction" row for the BODY domain).

There were no substantial differences between children and adults in their _MIND_ scores (see Table 5.3 and Figure 5.4, bottom row).
