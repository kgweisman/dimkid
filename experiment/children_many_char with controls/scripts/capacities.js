function makeCapacities() {
	...
	// add control trials
	addCapacity("metal", "is made out of metal", "like it has metal inside of it");
	addCapacity("on_off", "can be turned on and off", "like you can do something to turn it on and then turn it off");
