...
ggplot(scores_s34_plotting %>%
         ...
         mutate(character = factor(character, 
                ...
                age_group = factor(age_group,
                                  ...
                                  labels = c("Study 1 (7-9y)", "Study 2 (4-6y)"))),
...
```{r}
contrasts(scores_s34_plotting$factor) <- cbind(heart = c(1, 0, -1),
                                               mind = c(0, 1, -1))
contrasts(scores_s34_plotting$character) <- cbind(animate = c(5, 5, -4, -4, 5, 5, 5, -4, -4),
...
s34_robot_cat <- ggplot(d34_all %>%
                      ...
                      mutate(study = factor(study,
                                            ...
                                            labels = c("Study 1 (4-6y)", "Study 2 (7-9y)"))) %>%
  ...
  scale_fill_brewer(name = "Study:", palette = "Set1") +
