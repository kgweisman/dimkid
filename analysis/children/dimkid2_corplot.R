...
corplot_d3_adult <- make_corplot_df(d3_adult, "cor", "varimax")
corplot_d3_child <- make_corplot_df(d3_child, "cor", "varimax")
corplot_d3_combined <- make_corplot_df(d3_combined, "cor", "varimax")
